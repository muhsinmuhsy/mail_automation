...
export const visualStarters: VisualStarterSeed[] = [
  ...
  },
  {
    ...
    content: content([
      section('job-s1', [[
        title('job-t1', 'Thank you for applying!'),
        paragraph('job-p1', 'Hi {{name}}, thanks for your interest in joining our team.'),
        paragraph('job-p2', 'We have received your application and will review it carefully. Here is what happens next:'),
        paragraph('job-p3', '1. Our hiring team reviews your application'),
        paragraph('job-p4', '2. If your profile matches, we will reach out to schedule an interview'),
        paragraph('job-p5', '3. You will hear from us within 5-7 business days'),
        button('job-b1', 'View Application Status', 'https://example.com/applications'),
        divider('job-d1'),
        paragraph('job-p6', 'Questions? Reply to this email anytime.'),
      ]]),
    ]),
  },
];
