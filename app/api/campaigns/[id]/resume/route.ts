...
export async function POST(
  ...
  try {
    ...
    const rateLimitResult = await checkApiRateLimit(request, session.user.id, 'campaign-resume');
    ...
    return withRequestId(NextResponse.json(success(null, 'Campaign resumed.')), requestId);
  } catch {
