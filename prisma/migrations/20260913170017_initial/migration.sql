...
-- CreateEnum
CREATE TYPE "FieldType" AS ENUM ('text', 'number', 'date', 'boolean', 'dropdown');
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_campaign_submissions_campaign_id" ON "campaign_submissions"("campaign_id");

-- CreateIndex
CREATE INDEX "idx_campaign_submissions_user_created" ON "campaign_submissions"("user_id", "created_at");

-- CreateIndex
CREATE UNIQUE INDEX "uq_campaign_submissions_user_key" ON "campaign_submissions"("user_id", "idempotency_key");
...
-- AddForeignKey
ALTER TABLE "campaign_submissions" ADD CONSTRAINT "campaign_submissions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
